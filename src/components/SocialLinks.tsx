  ...
  return (
    <div className="flex items-center gap-8">
      ...
      <a
        ...
        className="group relative -m-3 block p-3 text-white/60 transition-colors duration-300"
      >
      ...
      <a
        ...
        rel="noopener noreferrer"
        aria-label="LinkedIn"
        className="group -m-3 block p-3 text-white/60 transition-colors duration-300 hover:text-[#0A66C2] focus-visible:text-[#0A66C2] active:text-[#0A66C2]"
      >
      ...
      <a
        ...
        rel="noopener noreferrer"
        aria-label="Facebook"
        className="group -m-3 block p-3 text-white/60 transition-colors duration-300 hover:text-[#1877F2] focus-visible:text-[#1877F2] active:text-[#1877F2]"
      >
        <svg width="30" height="30" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      ...
      <a
        ...
        aria-label="Llamar"
        className="group -m-3 block p-3 text-white/60 transition-colors duration-300 hover:text-[#22C55E] focus-visible:text-[#22C55E] active:text-[#22C55E]"
      >
        <svg width="30" height="30" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
