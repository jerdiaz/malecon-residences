...
export default function ScrollCue() {
  return (
    <button
      ...
      className="group absolute bottom-11 left-1/2 z-10 flex -translate-x-1/2 flex-col items-center gap-3 [@media(min-height:780px)]:bottom-10"
    ...
    >
      ...
      <span className="relative h-8 w-px overflow-hidden bg-white/15 [@media(min-height:780px)]:h-12">
